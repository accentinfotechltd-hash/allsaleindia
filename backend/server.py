...
api.include_router(sponsored.router)
api.include_router(sponsored.webhook_router)
api.include_router(stock_waitlist.router)
...
api.include_router(admin_user_actions.router)

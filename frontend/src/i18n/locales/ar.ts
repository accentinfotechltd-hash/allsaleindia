const ar = {
  ...
  auth: { welcome: "مرحباً بك في Allsale", subtitle: "السوق الهندي — شحن عالمي", sign_in: "تسجيل الدخول", sign_up: "إنشاء حساب", sign_out: "تسجيل الخروج", email: "البريد الإلكتروني", password: "كلمة المرور", full_name: "الاسم الكامل", forgot_password: "هل نسيت كلمة المرور؟", google: "المتابعة عبر Google", apple: "المتابعة عبر Apple", or: "أو",
    ...
    welcome_hero_title: "الهند الأصيلة،\nتُوصَّل إلى بابك.",
    welcome_hero_subtitle: "تسوّق في الهند كما يفعل الهنود — بدون السفر.",
    welcome_usp_sellers: "مباشرة من البائعين الهنود",
    welcome_usp_shipping: "الشحن إلى نيوزيلندا خلال 7-14 يومًا",
    welcome_usp_payments: "مدفوعات آمنة بالدولار النيوزيلندي",
    welcome_or: "أو",
    welcome_continue_google: "متابعة باستخدام Google",
